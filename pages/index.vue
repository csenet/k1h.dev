<template>
  <div>
    ...
    <!-- Skills -->
    <!--
    <b-jumbotron fluid bg-variant="light" class="mt-0 mb-0 pb-5">
      <b-container class="text-center">
        <h1 class="display-5">Skills</h1>
        <p class="text-muted">What I can Create and Use</p>
        <div class="d-flex justify-content-center">
          <b-img src="~/assets/img/code.svg" width="100" class="icons"></b-img>
          <b-img src="~/assets/img/cpu.svg" width="100" class="icons"></b-img>
          <b-img src="~/assets/img/web.svg" width="100" class="icons"></b-img>
        </div>
        <p>
          Electronic Work<br class="br-sp" />
          (Arduino, STM, ESP32 etc)<br />
          Programming<br class="br-sp" />
          (C, C++, JavaScript, Python etc)<br />
          Web (HTML, CSS, Nuxt etc)
        </p>
        <p>
          <nuxt-link to="/skills">
            <b-button variant="outline-dark">About my Skill</b-button>
          </nuxt-link>
        </p>
      </b-container>
    </b-jumbotron>
    ...
    <b-jumbotron bg-variant="white" class="mt-0 mb-0 pb-5">
      <b-container class="text-center">
        ...
        <p>
          <b-img-lazy
            src="~/assets/works/hirachikun4gou/thumnail.jpg"
            alt="平地君4号"
            rounded
            width="200"
            class="mx-3 pt-3 pb-3"
          >
          </b-img-lazy>
          <b-img-lazy
            src="~/assets/works/vconf/thumnail.jpg"
            alt="V会議"
            rounded
            width="200"
            class="mx-3 pt-3 pb-3"
